    ...
    container.innerHTML = `
      ...
      <div class="director-kpi-grid">
        <div class="director-kpi-card">
          ...
          <div class="director-kpi-value">₹${totalBudget.toLocaleString()}</div>
        ...
        <div class="director-kpi-card">
          ...
          <div class="director-kpi-value">₹${totalSpent.toLocaleString()}</div>
        ...
        <div class="director-kpi-card">
          ...
          <div class="director-kpi-value">₹${stipendsDisbursed.toLocaleString()}</div>
        ...
        <div class="director-kpi-card">
          ...
          <div class="director-kpi-value">₹${pendingInvoiceAmount.toLocaleString()}</div>
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:1rem;">
          <div style="background:#f3e8ff; padding:1.25rem; border-radius:10px; border:1px solid #d8b4fe;">
            <div style="display:flex; justify-space-between; align-items:center;">
              ...
              <strong style="color:#7e22ce; font-size:1.1rem;">₹${(payrollByTrack.Nova || 0).toLocaleString()}</strong>
            </div>
          ...
          <div style="background:#dbeafe; padding:1.25rem; border-radius:10px; border:1px solid #93c5fd;">
            <div style="display:flex; justify-content:space-between; align-items:center;">
              ...
              <strong style="color:#1d4ed8; font-size:1.1rem;">₹${(payrollByTrack.Orbit || 0).toLocaleString()}</strong>
            </div>
          ...
          <div style="background:#d1fae5; padding:1.25rem; border-radius:10px; border:1px solid #6ee7b7;">
            <div style="display:flex; justify-content:space-between; align-items:center;">
              ...
              <strong style="color:#047857; font-size:1.1rem;">₹${(payrollByTrack.Spark || 0).toLocaleString()}</strong>
            </div>
      ...
      <div class="director-panel">
        ...
        <div class="director-table-responsive">
          <table class="director-table">
            ...
            <tbody>
              ${projects.length === 0 ? `
                <tr><td colspan="6" style="text-align:center; color:#9ca3af; padding:1.5rem;">No active project financial records.</td></tr>
              ` : projects.map(p => {
