...
const repositories = [
  {
    ...
    repository:
      'https://github.com/ann-jo-mathew/hospital-management',
    submittedDate: '09 Aug 2026',
    status: 'Pending Verification'
  },
  {
    projectName: 'RLabZ ERP',
    students: ['Sandra', 'Roshan', 'Lena'],
    repository:
      'https://github.com/ann-jo-mathew/Rlabz_ERP',
  ...
  },
  {
    ...
    students: ['Arun', 'Megha'],
    repository:
      'https://github.com/student/temple-booking',
...
export function FacultyGithub(route, router) {
  ...
  container.innerHTML = `
    <div class="faculty-github-header">
      <div>
          ...
          <div class="github-project-card">
            ...
            <div class="github-project-body">
              ...
              <div class="github-info">
                <span class="github-label">Students</span>
                <p>${repo.students.join(', ')}</p>
              </div>

              <div class="github-info">
                <span class="github-label">Repository</span>
              ...
              <div class="github-info">
                <span class="github-label">Submitted Date</span>
                <p>${repo.submittedDate}</p>
              </div>
  ...
  function applySearch() {
    ...
    const filteredRepositories = repositories.filter((repo) =>
      repo.projectName.toLowerCase().includes(searchText)
    );
