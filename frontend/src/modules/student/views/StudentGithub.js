        ...
        <tr>
          ...
          <td>
            <div style="display: flex; align-items: center; gap: 8px;">
              ...
              <a href="${r.url}" target="_blank" rel="noopener noreferrer" style="color: var(--primary); font-size: 0.85rem; word-break: break-all; font-weight: 600; text-decoration: underline;" title="Open in GitHub">
                ${r.url}
              </a>
            </div>
          </td>
