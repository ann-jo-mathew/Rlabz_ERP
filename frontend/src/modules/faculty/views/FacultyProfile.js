                ...
                <div class="simple-profile-card">
                    ...
                    <div class="simple-profile-avatar-wrap">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 5px; align-items: center; width: 100%;">
                            <button type="button" id="btn-upload-photo" class="btn btn-sm" style="font-size: 0.75rem; padding: 0.32rem 0.7rem; background: var(--surface-card); border: 1px solid var(--primary); color: var(--primary); border-radius: 6px; display: inline-flex; align-items: center; gap: 4px; cursor: pointer; white-space: nowrap;">
