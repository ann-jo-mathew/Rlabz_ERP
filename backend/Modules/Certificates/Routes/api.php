...
Route::group(['prefix' => 'certificates', 'middleware' => ['auth.jwt']], function () {
    ...
    Route::get('/final-documents', [CertificatesController::class, 'finalDocuments']);
    ...
    Route::post('/projects/{project}/final-document', [CertificatesController::class, 'saveFinalDocument']);
